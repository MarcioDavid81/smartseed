...
import { useDeleteRain } from "@/queries/industry/use-rain";
...
const DeleteRainButton = ({ chuva }: Props) => {
  const [isOpen, setIsOpen] = useState(false);
  const { mutate, isPending } = useDeleteRain();
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {`Esta ação é irreversível e excluirá o registro de chuva em ${chuva.farm.name} permanentemente.`}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
...
export default DeleteRainButton;
