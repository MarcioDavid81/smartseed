...
import CreateIndustryTransporterButton from "./CreateTransporterButton";
...
export function IndustryTransporterDataTable<TData, TValue>({
  columns,
  data,
  pageSize = 8,
  searchFields = [],
  ...
  return (
    <div className="space-y-4 dark:bg-primary rounded-md">
      <div className="flex items-center justify-between py-4">
        ...
        <CreateIndustryTransporterButton />
      </div>
