...
import { useDeleteFarm } from "@/queries/registrations/use-farm";
...
const DeleteFarmButton = ({ farm }: Props) => {
  const [isOpen, setIsOpen] = useState(false);
  const { mutate, isPending } = useDeleteFarm();
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {`Esta ação é irreversível e excluirá o registro de ${farm.name} permanentemente.`}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
