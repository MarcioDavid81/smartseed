...
import { useDeleteCustomer } from "@/queries/registrations/use-customer";
...
const DeleteCustomerButton = ({ customer }: Props) => {
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {`Esta ação é irreversível e excluirá o registro de ${customer.name} permanentemente.`}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
