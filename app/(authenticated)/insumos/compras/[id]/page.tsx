...
import { InputPurchaseDetailsView } from "./_components/InputPurchaseDetailsView";
...
export default async function InputPurchaseDetailsPage({ params }: Props) {
  return (
    <div className="flex flex-col w-full min-h-screen bg-found">
      <div className="min-h-screen w-full flex bg-background">
        <main className="flex-1 py-4 px-4 md:px-8 text-gray-800 overflow-x-auto min-w-0">
          ...
          <InputPurchaseDetailsView id={params.id} />
        </main>
      </div>
    </div>
  );
