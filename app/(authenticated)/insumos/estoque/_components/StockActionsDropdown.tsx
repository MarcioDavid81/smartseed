...
export function StockActionsDropdown({ productId, farmId }: Props) {
  return (
    <TooltipProvider>
      <Tooltip>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="font-light">
            <DropdownMenuItem className="cursor-pointer py-2 hover:bg-green hover:text-white rounded-lg">
              <Link href={`/insumos/estoque/extrato?productId=${productId}&farmId=${farmId}`} className="w-full flex items-center gap-2 font-light">
