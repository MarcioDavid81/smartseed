...
interface StcokByProductTypeChartProps {
  className: string;
}


export default function StockByProductTypeChart({ className }: StcokByProductTypeChartProps) {
  ...
  return (
    <div className={`space-y-4 p-4 border rounded-xl shadow bg-white ${className}`}>
