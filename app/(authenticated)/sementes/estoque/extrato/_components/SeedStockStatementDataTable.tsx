...
import GenerateSeedExtractReportModal, { Movement } from "./GenerateExtractReportModal";
...
export function SeedStockStatementDataTable<TData, TValue>({
  columns,
  data,
  pageSize = 10,
  searchFields = [],
    ...
    <div className="space-y-4 dark:bg-primary rounded-md">
      ...
      {/* Paginação */}
        <div className="flex items-center justify-between space-x-2 dark:text-primary">
          <GenerateSeedExtractReportModal
