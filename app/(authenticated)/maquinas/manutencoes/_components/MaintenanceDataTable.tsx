...
import CreateMaintenanceButton from "./CreateMaintenanceButton";
import GenerateMaintenanceReportModal from "./GenerateMaintenanceReportModal";
  ...
  return (
    <div className="space-y-4 dark:bg-primary rounded-md">
      ...
      <div className="flex items-center justify-between space-x-2 dark:text-primary">
        <GenerateMaintenanceReportModal  />
