...
import { useDeleteMaintenance } from "@/queries/machines/use-delete-maintenance";
...
const DeleteMaintenanceButton = ({ manutencao, disabled = false }: Props) => {
  const [isOpen, setIsOpen] = useState(false);
  const { showToast } = useSmartToast();

  const { mutate, isPending } = useDeleteMaintenance();
